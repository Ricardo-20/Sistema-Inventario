...
public class MenuMantenimientoProveedoresFrame extends JFrame{

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		MenuMantenimientoProveedoresFrame MenuPrincipal = new MenuMantenimientoProveedoresFrame();
	}
	
	public MenuMantenimientoProveedoresFrame() {
		...
		setTitle("MANTENIMIENTO DE PROOVEDORES");
	...
	private class OpcionesMenu extends JPanel{
		...
		public OpcionesMenu() {
			...
			Btn1 = new JButton("Registro de proovedores", iconoEscaladoAdd);
			Btn2 = new JButton("Eliminar proovedor", iconoEscaladoRest);
			Btn3 = new JButton("Imprimir proovedores",iconoEscaladoView );
			...
			Btn1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					RegistroProveedoresFrame registroProovedor = new RegistroProveedoresFrame();
			...
			Btn2.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					EliminarProveedoresFrame eliminarProovedor = new EliminarProveedoresFrame();
			...
			Btn3.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					ImprimirProveedoresFrame imprimirProovedor = new ImprimirProveedoresFrame();

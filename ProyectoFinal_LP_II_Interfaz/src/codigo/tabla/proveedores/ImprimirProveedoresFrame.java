...
public class ImprimirProveedoresFrame extends JFrame {
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		ImprimirProveedoresFrame deleteProovedor = new ImprimirProveedoresFrame();

	}

	
	public ImprimirProveedoresFrame() {
		...
		setIconImage(icono);
		setResizable(false);
		setTitle("IMPRIMIR PROOVEDOR");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		add(new ImprimirProovedorPanel());
		setVisible(true);
	}
	
	private class ImprimirProovedorPanel extends JPanel {
		...
		public ImprimirProovedorPanel() {
			...
			btnBusquedaTotal = new JButton("Mostrar Tabla de Proovedores", iconoEscaladoLista);

...
public class ImprimirProductosFrame extends JFrame{
	
	public static void main(String[] args) {
		
		ImprimirProductosFrame deleteProovedor = new ImprimirProductosFrame();

	}

	
	public ImprimirProductosFrame() {
		...
		setTitle("IMPRIMIR PRODUCTO");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		add(new ImprimirProductoPanel());
		setVisible(true);
	}
	
	private class ImprimirProductoPanel extends JPanel {
		...
		public ImprimirProductoPanel() {
			...
			btnBusquedaTotal = new JButton("Mostrar Tabla de Productos", iconoEscaladoLista);
			...
			btnBusquedaPersonalizada.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					BusquedaPersonalizadaFrame irBusquedaProducto = new BusquedaPersonalizadaFrame();
			...
			btnBusquedaTotal.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					MostrarTablaGeneral tablaGeneralProductos = new MostrarTablaGeneral();

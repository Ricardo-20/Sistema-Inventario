...
import codigo.tabla.proveedores.RegistroProveedoresFrame;


public class MenuMantenimientoProductosFrame extends JFrame{

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		MenuMantenimientoProductosFrame MenuPrincipal = new MenuMantenimientoProductosFrame();
	}
	
	public MenuMantenimientoProductosFrame() {
	...
	private class OpcionesMenu extends JPanel{
		...
		public OpcionesMenu() {
			...
			Btn1 = new JButton("Registro de producto", iconoEscaladoAdd);
			Btn2 = new JButton("Eliminar producto", iconoEscaladoRest);
			Btn3 = new JButton("Imprimir productos",iconoEscaladoView );
			...
			Btn1.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					RegistroProductosFrame newRegistroProducto = new RegistroProductosFrame();
			...
			Btn2.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					EliminarProductosFrame newEliminarProducto = new EliminarProductosFrame();
			...
			Btn3.addActionListener(new ActionListener() {
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					ImprimirProductosFrame newImprimirPoducto= new ImprimirProductosFrame();

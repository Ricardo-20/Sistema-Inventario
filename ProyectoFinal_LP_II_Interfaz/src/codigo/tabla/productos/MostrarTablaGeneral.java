...
public class MostrarTablaGeneral extends JFrame {
	...
	public MostrarTablaGeneral() {
		...
		setTitle("LISTA GENERAL DE PRODUCTOS");
	...
	public class LaminaTable extends JPanel {
		...
		private String[] nombreColumnas = { "Codigo", "Descripcion" };
				...
				public void actionPerformed(ActionEvent e) {
					try {
						...
						JOptionPane.showMessageDialog(null, "Mensaje del sistema:\n" +
		                        "No se pudo ejectuar la accion indicada","Error!",

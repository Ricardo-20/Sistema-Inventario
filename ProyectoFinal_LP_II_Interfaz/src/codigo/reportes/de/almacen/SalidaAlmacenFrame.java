...
public class SalidaAlmacenFrame extends JFrame{
	
	// TODO Auto-generated method stub
	public static void main(String[] args) {
	
		SalidaAlmacenFrame tablaSalidaAlmacen = new SalidaAlmacenFrame();
	}
	
	
	public SalidaAlmacenFrame() {
	//DE ACA 
	...
	setTitle("LISTA GENERAL DE PRODUCTOS RETIRADOS");
	setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
	//HASTA LA FILA DE ARRIBA NO ME TOQUES ESTOS YA QUE ES LA VENTANA SU CONFIGURACION
	
	add(new SalidaTablaAlmacen());
	
	setVisible(true);
	}
	
	
	private class SalidaTablaAlmacen extends JPanel{
		...
		private String[] nombreColumnas = {"Codigo almacen", "Descripcion de almacne", "Operacion", "Cantidad retirada"};
		
		MovimientosFicheroBinario ficheroMovimientoBinario;
		
		public SalidaTablaAlmacen() {
			...
			//ACA AGREGAMOS LOS EL VECTOR DE MI NOMBRECOLUMNA Y LA MATRIZ DE DATOSFILA
		 	tablaAlmacen = new JTable(ficheroMovimientoBinario.mostrarArrayTableSalida(),nombreColumnas);
